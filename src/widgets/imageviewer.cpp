...
imageViewer::imageViewer(QWidget *parent): QLabel(parent)
{
  ...
  connect(toTXAct, &QAction::triggered, this, &imageViewer::slotToTX);
  editAct = new QAction(tr("&Edit"), this);
  connect(editAct, &QAction::triggered, this, &imageViewer::slotEdit);
  printAct = new QAction(tr("&Print"), this);
  connect(printAct, &QAction::triggered, this, &imageViewer::slotPrint);
  uploadAct = new QAction(tr("&Upload to FTP"), this);
  connect(uploadAct, &QAction::triggered, this, &imageViewer::slotUploadFTP);
  deleteAct = new QAction(tr("&Delete"), this);
  connect(deleteAct, &QAction::triggered, this, &imageViewer::slotDelete);
  viewAct = new QAction(tr("&View"), this);
  connect(viewAct, &QAction::triggered, this, &imageViewer::slotView);
  propertiesAct = new QAction(tr("Propert&ies"), this);
  connect(propertiesAct, &QAction::triggered, this, &imageViewer::slotProperties);
  zoomInAct = new QAction(tr("Zoom In (&+)"), this);
  connect(zoomInAct, &QAction::triggered, this, &imageViewer::slotZoomIn);
  zoomOutAct = new QAction(tr("Zoom Out (&-)"), this);
  connect(zoomOutAct, &QAction::triggered, this, &imageViewer::slotZoomOut);
  connect(configDialogPtr, &configDialog::bgColorChanged, this, &imageViewer::slotBGColorChanged);
