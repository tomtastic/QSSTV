...
directoriesConfig::directoriesConfig(QWidget* parent) : baseConfig(parent), ui(new Ui::directoriesConfig) {
  ...
  connect(ui->txSSTVImagesPathBrowseButton, &QPushButton::clicked, this,
          &directoriesConfig::slotBrowseTxSSTVImagesPath);
  connect(ui->txDRMImagesPathBrowseButton, &QPushButton::clicked, this, &directoriesConfig::slotBrowseTxDRMImagesPath);
  connect(ui->txStockImagesPathBrowseButton, &QPushButton::clicked, this,
          &directoriesConfig::slotBrowseTxStockImagesPath);
