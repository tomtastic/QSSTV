...
/*!
    ...
    \param extension if extension is not empty or nullptr, then this string will be appended to the filename. A dot will
   automatically be inserted (i.e specify "txt" not ".txt").
