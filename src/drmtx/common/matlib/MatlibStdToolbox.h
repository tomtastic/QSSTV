...
public:
  ...
  CFftPlans(const int iFftSize) : RFFTPlForw(nullptr), RFFTPlBackw(nullptr), bInitialized(false)
  {
    Init(iFftSize);
  }
  virtual ~CFftPlans();
...
template <class T> inline CMatlibVector<T> Sin(const CMatlibVector<T>& vecI)
{
...
template <class T> inline CMatlibVector<T> Cos(const CMatlibVector<T>& vecI)
{
...
template <class T> inline CMatlibVector<T> Tan(const CMatlibVector<T>& vecI)
{
...
template <class T> inline CMatlibVector<T> Sinh(const CMatlibVector<T>& vecI)
{
...
template <class T> inline CMatlibVector<T> Cosh(const CMatlibVector<T>& vecI)
{
...
template <class T> inline CMatlibVector<T> Tanh(const CMatlibVector<T>& vecI)
{
...
template <class T> inline CMatlibVector<T> Sqrt(const CMatlibVector<T>& vecI)
{
...
template <class T> inline CMatlibVector<T> Exp(const CMatlibVector<T>& vecI)
{
...
template <class T> inline CMatlibVector<T> Log(const CMatlibVector<T>& vecI)
{
...
template <class T> inline CMatlibVector<T> Log10(const CMatlibVector<T>& vecI)
{
...
template <class T> inline T Sum(const CMatlibVector<T>& vecI)
{
...
template <class T> inline T Var(const CMatlibVector<T>& vecI)
{
  const int iSize = vecI.GetSize();
