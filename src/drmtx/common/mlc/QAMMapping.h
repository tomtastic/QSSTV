...
public:
  ...
  void Map(CVector<_DECISION>& vecInputData1, CVector<_DECISION>& vecInputData2, CVector<_DECISION>& vecInputData3,
           CVector<_DECISION>& vecInputData4, CVector<_DECISION>& vecInputData5, CVector<_DECISION>& vecInputData6,
